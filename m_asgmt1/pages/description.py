...
img = image.imread("C://Users//Mrudula Madhavan//OneDrive//Desktop//Innomatics//m_asgmt1//resources//images//credit img.jpg")
st.image(img)
...
if (status == 'View Dataset'):
    ...
    img = image.imread("C://Users//Mrudula Madhavan//OneDrive//Desktop//Innomatics//m_asgmt1//resources//images//info.jpg")
    st.image(img)   
else:       
